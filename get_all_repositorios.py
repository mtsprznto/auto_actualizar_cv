...
def main():
    try:
        ...
        #print("Proyectos combinados:", proyectos_combinados[0]["titulo"])
        ...
        generar_cv(proyectos_destacados=proyectos_filtrados, output_path='./data/CV_Matias_Perez_Nauto_all.pdf')
